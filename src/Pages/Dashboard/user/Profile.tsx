...
const Profile = () => {
  ...
  return (
       <div className="w-full bg-white mx-auto rounded-md my-4 px-2 py-4">
           <h1 className=" text-xl font-bold text-[#020C29] italic underline mb-2">Profile <span className="text-orange-500 ">Overview</span></h1>
          ...
          <Badge className={`${userData?.data?.status?"bg-green-600":"bg-red-600"}`}>{userData?.data?.status}</Badge>
           </div>
           <div  className="bg-slate-100 px-4 py-2 rounded-md flex flex-col gap-2">
